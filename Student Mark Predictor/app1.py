...
app = Flask(__name__)
model = joblib.load(r"C:\Users\shree\Desktop\FSDS&AI\May Month\4. Students mark prediction\Student Mark Predictor Project Deployment\Student mark Predictor Deployment\student_mark_predictor.pkl")
